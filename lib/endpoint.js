...
Endpoint = (function() {
  ...
  Endpoint.prototype.check = function(method, f) {
    this.checks[method] = f;
    return this;
  };
  ...
  Endpoint.prototype.finishPut = function(req, model, data, deferred) {
    ...
    this.model.set(data);
    if (this.cascadeRelations.length && (this.model.cascadeSave != null)) {
      return this.model.cascadeSave(function(err, model) {
        var returnVal;
        if (err) {
          return deferred.reject(httperror.forge(err, 400));
        }
      ...
      return this.model.save(function(err, model) {
        var returnVal;
        if (err) {
          return deferred.reject(httperror.forge(err, 400));
        }
  ...
  Endpoint.prototype.register = function(app) {
    ...
    app.get(this.path + '/:id', this.middleware.get, function(req, res) {
      return Q(_this.get(req)).then(function(results) {
        return _this.response('get', req, res, results, 200).send();
      }, function(error) {
        console.error(error);
    ...
    app.get(this.path, this.middleware.get, function(req, res) {
      return Q(_this.list(req, res)).then(function(results) {
